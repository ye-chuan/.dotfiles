...
(gtk_accel_path "<Actions>/ThunarActions/uca-action-1611168259857250-1" "<Primary>Return")
...
(gtk_accel_path "<Actions>/ThunarWindow/cancel-search" "<Primary>bracketleft")
